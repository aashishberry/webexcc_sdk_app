...
app.post('/api/diagnostics/events', requireSameOrigin, requireSession, (request, response) => {
  ...
  if (['pause', 'resume', 'start', 'stop', 'exit', 'accept', 'decline', 'mute', 'unmute', 'dtmf', 'hold', 'end', 'mid-call', 'post-call', 'drop', 'transfer', 'likeButton', 'dislikeButton', 'copyButton'].includes(details.action)) {
